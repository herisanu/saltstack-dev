...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=tests/*",
            "--include=src/saltext/aws_management/*",
        )
        ...
        session.run(
            ...
            "--omit=src/saltext/aws_management/*",
            "--include=tests/*",
        )
        try:
            session.run(
                "coverage", "report", "--show-missing", "--include=src/saltext/aws_management/*"
            )
            ...
            #    "--include=src/saltext/aws_management/*,tests/*"
            # )
        finally:
